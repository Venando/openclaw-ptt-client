...
public class AgentHotkeyServiceTests : IDisposable
{
    ...
    public void HotkeyPressed_ActiveAgent_StartsRecording()
    {
        ...
        using var svc = new AgentHotkeyService(pttCtrl.Object, Mock.Of<ITextMessageSender>(), Mock.Of<IStreamShellHost>(), new AppConfig(), null, _factory);
    ...
    public void HotkeyPressed_InactiveAgent_SwitchesAndShowsMessage()
    {
        ...
        using var svc = new AgentHotkeyService(pttCtrl.Object, sender.Object, shellHost.Object, new AppConfig(), null, _factory);
    ...
    public void HotkeyReleased_HoldToTalkActiveAgent_StopsRecording()
    {
        ...
        using var svc = new AgentHotkeyService(pttCtrl.Object, Mock.Of<ITextMessageSender>(), Mock.Of<IStreamShellHost>(), cfg, null, _factory);
