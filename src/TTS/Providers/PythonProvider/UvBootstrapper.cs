...
public sealed class UvBootstrapper
{
    ...
    public static string ResolveDownloadUrl()
    {
        ...
        {
            osPart = RuntimeInformation.OSArchitecture switch
            {
        ...
        string ext = RuntimeInformation.IsOSPlatform(OSPlatform.Windows) ? ".zip" : ".tar.gz";
        return $"{UvReleaseBaseUrl}/uv-{osPart}{ext}";
    }
